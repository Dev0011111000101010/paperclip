...
export function ExecutionWorkspaceDetail() {
  ...
  const controlRuntimeServices = useMutation({
    ...
    onError: (error) => {
      ...
      setRuntimeActionErrorMessage(error instanceof Error ? error.message : t("errors.failed_to_update"));
    },
  });
          ...
          <div className="space-y-4 sm:space-y-6">
            <div className="rounded-2xl border border-border bg-card p-4 sm:p-5">
              ...
              <div className="space-y-4">
                <Field label={t("form_labels.workspace_name")}>
                  <input
                ...
                <Field label={t("form_labels.provision_command")} hint="Runs when Paperclip prepares this execution workspace">
                  <textarea
                ...
                <Field label={t("form_labels.teardown_command")} hint="Runs when the execution workspace is archived or cleaned up">
                  <textarea
                    className="min-h-20 w-full rounded-lg border border-border bg-background px-3 py-2 font-mono text-sm outline-none sm:min-h-28"
                ...
                <Field label={t("form_labels.cleanup_command")} hint="Workspace-specific cleanup before teardown">
                  <textarea
                ...
                <details className="rounded-xl border border-dashed border-border/70 bg-muted/20 px-3 py-3">
                  ...
                  <div className="mt-3">
                    <Field label={t("form_labels.workspace_commands_json")} hint="Legacy `services` arrays still work, but `commands` supports both services and jobs.">
