                    ...
                    >
                      <div>
                        ...
                        <div className="text-muted-foreground">
                          {membership.membershipRole ? t(`access.role_${membership.membershipRole}`, { defaultValue: membership.membershipRole }) : t("access.role_unset")} • {t(`access.status_${membership.status}`, { defaultValue: membership.status })}
                        </div>
                      </div>
