        ...
        <div className="rounded-lg border border-blue-500/30 bg-blue-500/5 p-4 space-y-3 text-sm">
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              ...
              <Button variant="outline" size="sm" onClick={() => copySecretValue(t("detail.webhook_url_label"), secretMessage.webhookUrl)}>
            ...
            <div className="flex items-center gap-2">
              ...
              <Button variant="outline" size="sm" onClick={() => copySecretValue(t("detail.webhook_secret_label"), secretMessage.webhookSecret)}>
                <Copy className="h-3.5 w-3.5 mr-1" />
                      ...
                      <span className="text-muted-foreground truncate">
                        {Object.entries(event.details).slice(0, 3).map(([key, value], i) => (
                          <span key={key}>
                            ...
                            {key === "status"
                              ? t(`status.${String(value)}`, { defaultValue: formatActivityDetailValue(value) })
                              : key === "source"
                              ? t(`run_source.${String(value)}`, { defaultValue: formatActivityDetailValue(value) })
