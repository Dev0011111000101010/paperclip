                ...
                <div>
                  <h2 className="text-lg font-semibold">
                    {shouldAutoAcceptHumanInvite
                      ? t("invite.accept_auto_title")
                      : invite.inviteType === "bootstrap_ceo"
                        ? t("invite.accept_bootstrap_title")
                        : t("invite.accept_company_title")}
                  </h2>
                  <p className="mt-1 text-sm text-zinc-400">
                    {shouldAutoAcceptHumanInvite
                      ? t("invite.accept_auto_desc", { company: companyDisplayName })
                      : isCurrentMember
                      ? t("invite.accept_already_member", { company: companyDisplayName })
                      : invite.inviteType === "bootstrap_ceo"
                        ? t("invite.accept_bootstrap_desc")
                        : t("invite.accept_company_desc", { company: companyDisplayName })}
                  </p>
                </div>
                {error ? <p className="text-xs text-red-400">{error}</p> : null}
                {shouldAutoAcceptHumanInvite ? (
